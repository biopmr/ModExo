...
hold on
h2encoder = plot(SampleNumber10000samplesp1*0.05, Encoder1*qc_to_rad);
h2eposposition = plot(SampleNumber10000samplesp1*0.05, EPOSPosition1*qc_to_rad);
% h1model = plot(t,x_m(1,:));
