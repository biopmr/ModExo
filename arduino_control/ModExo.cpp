...
// Statemachine
set_preoperational[2] = {0x80, 0};
set_operational[2] = {0x1, 0};
enable_epos[8] = {0x2B, 0x40, 0x60, 0, 0x0F, 0, 0, 0};
disable_epos[8] = {0x2B, 0x40, 0x60, 0, 0x06, 0, 0, 0};

// PDO Configuration
pdo_sync[1] = {0x00};

pdo_actual_position_1[8] = {0x22, 0x02, 0x18, 0x01, 0x81, 0x03, 0, 0};
pdo_actual_position_2[8] = {0x22, 0x02, 0x18, 0x02, 0x01, 0, 0, 0};

pdo_actual_velocity_1[8] = {0x22, 0x02, 0x18, 0x01, 0x81, 0x03, 0, 0};
pdo_actual_velocity_2[8] = {0x22, 0x02, 0x18, 0x02, 0x01, 0, 0, 0};

pdo_actual_current_1[8] = {0x22, 0x00, 0x1A, 0x00, 0x00, 0, 0, 0};
pdo_actual_current_2[8] = {0x22, 0x00, 0x1A, 0x01, 0x10, 0, 0x78, 0x60};
pdo_actual_current_3[8] = {0x22, 0x00, 0x1A, 0x02, 0x10, 0, 0x27, 0x20};
pdo_actual_current_4[8] = {0x22, 0x00, 0x18, 0x02, 0x01, 0, 0, 0};
pdo_actual_current_5[8] = {0x22, 0x00, 0x1A, 0x00, 0x01, 0, 0, 0};
...
// Parameters
set_max_following_error[8] = {0x22, 0x65, 0x60, 0, 0xD0, 7, 0, 0};
set_max_acceleration[8] = {0x22, 0xC5, 0x60, 0, 0x88, 0x13, 0, 0};
set_max_profile_velocity[8] = {0x22, 0x7F, 0x60, 0, 0xD0, 7, 0, 0};
set_min_position_limit[8] = {0x22, 0x7D, 0x60, 0x01, 0x20, 0x6C, 0xFB, 0xFF}; // -300000qc = 0xFFFB6C20
set_max_position_limit[8] = {0x22, 0x7D, 0x60, 0x02, 0xE0, 0x93, 0x04, 0}; // 300000qc = 0x0493E0

// Commanding
setpoint_position[8] = {0x22, 0x62, 0x20, 0x00, 0, 0, 0, 0};
...
// Actual Values
get_actual_position[8] = {0x40, 0x64, 0x60, 0, 0, 0, 0, 0};
get_actual_velocity[8] = {0x40, 0x6C, 0x60, 0, 0, 0, 0, 0};
get_actual_current[8] = {0x40, 0x78, 0x60, 0, 0, 0, 0, 0};

// *****************
// System Variables
// *****************

encoder_resolution = 2000; //2000 counts per turn
reduction = 100; // harmonic drive reduction

CT_K = 0; // generic constant to be tweaked during runtime
...
j_h = 0; // Nms^2/rad
b_h = 0; // Nms/rad [2.5-4.7]
k_h = 0; // Nm/rad [5.3-13.1]
...
A = 0.0764; //slop steepness
// B = 118712.7; //offset
B = 118712.7+5000; //offset
d = 0.105; ////distancia entre os centros dos aros da celula de carga=10,5cm
